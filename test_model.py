# copyfrom "https://github.com/zt1112/pytorch_inceptionv3/blob/master/inception3.py"
import torch
    ...
    def __init__(self, num_classes=2, aux_logits=True, transform_input=False):
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d) or isinstance(m, nn.Linear):
                ...
                values = torch.Tensor(X.rvs(m.weight.data.numel())).reshape(m.weight.size())
                # print(m.weight.shape,values.shape)
